"""
PROMPT TEMPLATE — System prompt và User prompt cho Gemini 2.5 Pro.
Tuân thủ nghiêm ngặt các ràng buộc trong spec luatdich.md.
"""
import json


# ==============================================================================
# SYSTEM PROMPT — Hướng dẫn tổng quát cho Gemini
# ==============================================================================
...
def build_user_prompt(forecast_entry):
    """
    Xây dựng user prompt từ một bản ghi dự báo.
    
    Args:
        forecast_entry: dict — Một phần tử từ active_alerts.json
        
    Returns:
        str — User prompt hoàn chỉnh
    """
